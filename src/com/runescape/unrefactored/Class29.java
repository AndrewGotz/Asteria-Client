...
public final class Class29 {
    ...
    public void method325(JagBuffer jagBuffer) {
        anInt540 = jagBuffer.readUnsignedByte();
        anInt538 = jagBuffer.readDWord();
        anInt539 = jagBuffer.readDWord();
        method326(jagBuffer);
    }

    public void method326(JagBuffer jagBuffer) {
        anInt535 = jagBuffer.readUnsignedByte();
        anIntArray536 = new int[anInt535];
        anIntArray537 = new int[anInt535];
        for (int i = 0; i < anInt535; i++) {
            anIntArray536[i] = jagBuffer.readUnsignedShort();
            anIntArray537[i] = jagBuffer.readUnsignedShort();
        }
