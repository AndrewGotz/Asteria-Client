package com.runescape.unrefactored;
...
public final class Class6 {
    ...
    public void method169(JagBuffer jagBuffer) {
        aClass29_98 = new Class29();
        aClass29_98.method325(jagBuffer);
        aClass29_99 = new Class29();
        aClass29_99.method325(jagBuffer);
        int i = jagBuffer.readUnsignedByte();
        if (i != 0) {
            jagBuffer.currentOffset--;
            aClass29_100 = new Class29();
            aClass29_100.method325(jagBuffer);
            aClass29_101 = new Class29();
            aClass29_101.method325(jagBuffer);
        }
        i = jagBuffer.readUnsignedByte();
        if (i != 0) {
            jagBuffer.currentOffset--;
            aClass29_102 = new Class29();
            aClass29_102.method325(jagBuffer);
            aClass29_103 = new Class29();
            aClass29_103.method325(jagBuffer);
        }
        i = jagBuffer.readUnsignedByte();
        if (i != 0) {
            jagBuffer.currentOffset--;
            aClass29_104 = new Class29();
            aClass29_104.method325(jagBuffer);
            aClass29_105 = new Class29();
            aClass29_105.method325(jagBuffer);
        }
        for (int j = 0; j < 10; j++) {
            ...
            if (k == 0)
                break;
            anIntArray106[j] = k;
            anIntArray107[j] = jagBuffer.method421();
            anIntArray108[j] = jagBuffer.method422();
        }

        anInt109 = jagBuffer.method422();
        anInt110 = jagBuffer.method422();
        anInt113 = jagBuffer.readUnsignedShort();
        anInt114 = jagBuffer.readUnsignedShort();
        aClass39_111 = new Class39();
        aClass29_112 = new Class29();
        aClass39_111.method545(jagBuffer, aClass29_112);
    }
