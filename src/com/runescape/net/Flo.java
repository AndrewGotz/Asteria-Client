...
public final class Flo {
    ...
    public static void unpackConfig(StreamLoader streamLoader) {
        JagBuffer jagBuffer = new JagBuffer(streamLoader.getDataForName("flo.dat"));
    ...
    private void readValues(JagBuffer jagBuffer) {
        do {
            ...
            if (i == 0)
                ...
                anInt390 = jagBuffer.readTriByte();
                method262(anInt390);
            } else if (i == 2)
                anInt391 = jagBuffer.readUnsignedByte();
            else if (i == 3)
                dummy = true;
            else if (i == 5)
                aBoolean393 = false;
