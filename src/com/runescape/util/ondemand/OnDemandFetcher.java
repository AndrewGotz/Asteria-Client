...
import com.runescape.world.NodeSubList;
...
public final class OnDemandFetcher implements Runnable {
    ...
    public void start(StreamLoader streamLoader, Client client1) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            for (int l = 0; l < j; l++)
                versions[i][l] = jagBuffer.readUnsignedShort();
        ...
        for (int k = 0; k < 4; k++) {
            ...
            JagBuffer stream_1 = new JagBuffer(abyte1);
            crcs[k] = new int[i1];
        ...
        JagBuffer stream2 = new JagBuffer(abyte2);
        j1 = abyte2.length / 7;
        ...
        stream2 = new JagBuffer(abyte2);
        j1 = abyte2.length / 2;
        anIntArray1360 = new int[j1];
        for (int j2 = 0; j2 < j1; j2++)
            anIntArray1360[j2] = stream2.readUnsignedShort();
        ...
        try {
            if (socket == null) {
                ...
                if (l - openSocketTime < 4000L)
                    return;
                openSocketTime = l;
                socket = clientInstance.openSocket(43594);
