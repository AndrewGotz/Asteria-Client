...
import com.runescape.unrefactored.Class4;
...
public final class ObjectManager {
    ...
    public static void method173(JagBuffer jagBuffer, OnDemandFetcher class42_sub1) {
        label0: {
            int i = -1;
            do {
                int j = jagBuffer.method422();
                if (j == 0)
                    break label0;
                i += j;
            ...
            for (int i3 = 0; i3 < 64; i3++) {
                for (int j3 = 0; j3 < 64; j3++)
                    if (l2 == i && i3 >= i1 && i3 < i1 + 8 && j3 >= j1 && j3 < j1 + 8)
                        method181(l1 + Class4.method156(j3 & 7, j, i3 & 7), 0, jagBuffer, l + Class4.method155(j, j3 & 7, i3 & 7), k1, j, 0);
                    else
                        method181(-1, 0, jagBuffer, -1, 0, 0, 0);
        ...
        for (int l1 = 0; l1 < 4; l1++) {
            for (int i2 = 0; i2 < 64; i2++) {
                for (int j2 = 0; j2 < 64; j2++)
                    method181(j2 + i, l, jagBuffer, i2 + j, l1, 0, k);
    ...
    private void method181(int i, int j, JagBuffer jagBuffer, int k, int l, int i1, int k1) {
        if (k >= 0 && k < 104 && i >= 0 && i < 104) {
            ...
            do {
                ...
                if (l1 <= 49) {
                    aByteArrayArrayArray130[l][k][i] = jagBuffer.readSignedByte();
    ...
    public final void method183(Class11 aclass11[], WorldController worldController, int i, int j, int k, int l, byte abyte0[], int i1, int j1, int k1) {
        label0: {
            ...
            int l1 = -1;
            do {
                int i2 = jagBuffer.method422();
                if (i2 == 0)
                    break label0;
                l1 += i2;
                int j2 = 0;
                do {
                    int k2 = jagBuffer.method422();
                    if (k2 == 0)
                        break;
                    j2 += k2 - 1;
                    int l2 = j2 & 0x3f;
    ...
    {
        boolean bool = true;
        JagBuffer jagBuffer = new JagBuffer(is);
        int i_252_ = -1;
        for (;;) {
            int i_253_ = jagBuffer.method422();
            if (i_253_ == 0)
                break;
            i_252_ += i_253_;
            int i_254_ = 0;
            ...
            for (;;) {
                if (bool_255_) {
                    int i_256_ = jagBuffer.method422();
                    if (i_256_ == 0)
                        break;
                    jagBuffer.readUnsignedByte();
                } else {
                    int i_257_ = jagBuffer.method422();
                    if (i_257_ == 0)
                        break;
                    i_254_ += i_257_ - 1;
                    int i_258_ = i_254_ & 0x3f;
                    int i_259_ = i_254_ >> 6 & 0x3f;
                    int i_260_ = jagBuffer.readUnsignedByte() >> 2;
                    int i_261_ = i_259_ + i;
    ...
    public final void method190(int i, Class11 aclass11[], int j, WorldController worldController, byte abyte0[]) {
        label0: {
            ...
            int l = -1;
            do {
                int i1 = jagBuffer.method422();
                if (i1 == 0)
                    break label0;
                l += i1;
                int j1 = 0;
                do {
                    int k1 = jagBuffer.method422();
                    if (k1 == 0)
                        break;
                    j1 += k1 - 1;
                    int l1 = j1 & 0x3f;
