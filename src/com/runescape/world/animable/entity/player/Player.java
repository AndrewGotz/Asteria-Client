package com.runescape.world.animable.entity.player;
...
public final class Player extends Entity {
    ...
    public void updatePlayer(JagBuffer jagBuffer) {
        jagBuffer.currentOffset = 0;
        anInt1702 = jagBuffer.readUnsignedByte();
        headIcon = jagBuffer.readUnsignedByte();
        skullIcon = jagBuffer.readUnsignedByte();
        ...
        for (int j = 0; j < 12; j++) {
            ...
            if (j == 0 && equipment[0] == 65535) {
                desc = EntityDef.forID(jagBuffer.readUnsignedShort());
                break;
            }
        ...
        super.anInt1511 = jagBuffer.readUnsignedShort();
        if (super.anInt1511 == 65535)
            super.anInt1511 = -1;
        super.anInt1512 = jagBuffer.readUnsignedShort();
        if (super.anInt1512 == 65535)
            super.anInt1512 = -1;
        super.anInt1554 = jagBuffer.readUnsignedShort();
        if (super.anInt1554 == 65535)
            super.anInt1554 = -1;
        super.anInt1555 = jagBuffer.readUnsignedShort();
        if (super.anInt1555 == 65535)
            super.anInt1555 = -1;
        super.anInt1556 = jagBuffer.readUnsignedShort();
        if (super.anInt1556 == 65535)
            super.anInt1556 = -1;
        super.anInt1557 = jagBuffer.readUnsignedShort();
        if (super.anInt1557 == 65535)
            super.anInt1557 = -1;
        super.anInt1505 = jagBuffer.readUnsignedShort();
        if (super.anInt1505 == 65535)
            super.anInt1505 = -1;
        name = TextClass.fixName(TextClass.nameForLong(jagBuffer.readQWord()));
        combatLevel = jagBuffer.readUnsignedByte();
        skill = jagBuffer.readUnsignedShort();
        visible = true;
        aLong1718 = 0L;
