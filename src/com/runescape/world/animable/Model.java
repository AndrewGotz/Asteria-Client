package com.runescape.world.animable;

import com.runescape.applet.drawing.DrawingArea;
import com.runescape.net.JagBuffer;
import com.runescape.unrefactored.Class18;
import com.runescape.unrefactored.Class21;
import com.runescape.unrefactored.Class33;
...
public final class Model extends Animable {
    ...
    public static void method459(int i, OnDemandFetcher onDemandFetcherParent) {
    ...
    public static void method460(byte abyte0[], int j) {
        ...
        jagBuffer.currentOffset = abyte0.length - 18;
        Class21 class21_1 = aClass21Array1661[j] = new Class21();
        class21_1.aByteArray368 = abyte0;
        class21_1.anInt369 = jagBuffer.readUnsignedShort();
        class21_1.anInt370 = jagBuffer.readUnsignedShort();
        class21_1.anInt371 = jagBuffer.readUnsignedByte();
        ...
        int l1 = jagBuffer.readUnsignedShort();
        int i2 = jagBuffer.readUnsignedShort();
        int j2 = jagBuffer.readUnsignedShort();
        int k2 = jagBuffer.readUnsignedShort();
        int l2 = 0;
    ...
    private Model(int i) {
        ...
        JagBuffer jagBuffer = new JagBuffer(class21.aByteArray368);
        jagBuffer.currentOffset = class21.anInt372;
        JagBuffer stream_1 = new JagBuffer(class21.aByteArray368);
        stream_1.currentOffset = class21.anInt373;
        JagBuffer stream_2 = new JagBuffer(class21.aByteArray368);
        stream_2.currentOffset = class21.anInt374;
        JagBuffer stream_3 = new JagBuffer(class21.aByteArray368);
        stream_3.currentOffset = class21.anInt375;
        JagBuffer stream_4 = new JagBuffer(class21.aByteArray368);
        ...
        jagBuffer.currentOffset = class21.anInt379;
        ...
        for (int l1 = 0; l1 < anInt1630; l1++) {
            anIntArray1640[l1] = jagBuffer.readUnsignedShort();
        ...
        jagBuffer.currentOffset = class21.anInt377;
        ...
        for (int l3 = 0; l3 < anInt1630; l3++) {
            ...
            if (i4 == 1) {
                j2 = jagBuffer.method421() + k3;
                k3 = j2;
                l2 = jagBuffer.method421() + k3;
                k3 = l2;
                j3 = jagBuffer.method421() + k3;
                k3 = j3;
        ...
        jagBuffer.currentOffset = class21.anInt384;
        for (int j4 = 0; j4 < anInt1642; j4++) {
            anIntArray1643[j4] = jagBuffer.readUnsignedShort();
            anIntArray1644[j4] = jagBuffer.readUnsignedShort();
            anIntArray1645[j4] = jagBuffer.readUnsignedShort();
        }
