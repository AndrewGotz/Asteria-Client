...
public final class TextDrawingArea extends DrawingArea {
    ...
    public TextDrawingArea(boolean flag, String s, StreamLoader streamLoader) {
        ...
        stream_1.currentOffset = jagBuffer.readUnsignedShort() + 4;
        ...
        for (int l = 0; l < 256; l++) {
            ...
            if (k1 == 0) {
                for (int i2 = 0; i2 < l1; i2++)
                    aByteArrayArray1491[l][i2] = jagBuffer.readSignedByte();

            } else if (k1 == 1) {
                for (int j2 = 0; j2 < i1; j2++) {
                    for (int l2 = 0; l2 < j1; l2++)
                        aByteArrayArray1491[l][j2 + l2 * i1] = jagBuffer.readSignedByte();
